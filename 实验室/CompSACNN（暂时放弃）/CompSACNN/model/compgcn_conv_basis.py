...
class CompGCNConvBasis(MessagePassing):
	...
	def compute_norm(self, edge_index, num_ent):
		...
		deg		= torch.Tensor.scatter_add( edge_weight, row, dim=0, dim_size=num_ent)	# Summing number of weights of the edges [Computing out-degree] [Should be equal to in-degree (undireted graph)]
